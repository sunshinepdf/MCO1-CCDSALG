 ...
 * Description: a program that computes the convex hull of 2D points using Graham’s Scan with quickSort.
 * Authors:
 * Laborada, Nathan
 * Lee, Ashley Fiona
 ...
 * then calls grahamScan2(), which uses quickSort, to compute the convex hull.
 *
